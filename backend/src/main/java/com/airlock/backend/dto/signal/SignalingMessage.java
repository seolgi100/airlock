...
public class SignalingMessage {
    ...
    @Schema(description = "메시지 타입 (join, offer, answer, candidate)", example = "offer")
    private String type;

    @Schema(description = "보내는 사용자 ID 또는 username", example = "userA")
    private String from;

    @Schema(description = "받는 사용자 ID 또는 username", example = "userB")
    private String to;
